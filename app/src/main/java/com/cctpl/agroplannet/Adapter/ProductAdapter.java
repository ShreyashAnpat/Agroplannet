...
public class ProductAdapter extends RecyclerView.Adapter<ProductAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (AvailableProduct.get(position).equals("0")){
            holder.Available.setText("Out Of Stock");
            holder.Available.setTextSize(13);
        ...
        holder.Off.setText("(" + String.format("%.1f",((( Double.parseDouble(productMRP.get(position))  - Double.parseDouble(productSellingPrice.get(position)))/ Double.parseDouble(productMRP.get(position)))*100.0) )  +"%) ");
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView productDetails ,productSellingPrice,productMRP,Available , Off;
