...
public class cardAdapter extends RecyclerView.Adapter<cardAdapter.ViewHolder> {
    List<String> Image1,MRP, ProductDetails , ProductPrice , ProductCount ,ProductMeasurement , ProductSellingPrice ,availableProduct ;
    Context context ;
    LayoutInflater  inflater ;
    FirebaseAuth auth;
    FirebaseFirestore db ;

    public cardAdapter(Context context, List<String> image1, List<String> productDetails, List<String> productMeasurement, List<String> productPrice, List<String> productCount, List<String> MRP, List<String> productSellingPrice, List<String> availableProduct) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.Add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Integer.parseInt(availableProduct.get(position) ) >Integer.parseInt(holder.Amount.getText().toString()) ){
